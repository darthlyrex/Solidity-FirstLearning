...
contract Modifier {
    ...
    // The code is more professional now.   
    // We don't repeat the codes by using modifiers.
    ...
    // Modifiers are written to the end of the pages.       :Code Culture

    // _;     This is the body of the function that called the modifier.   
    // It means the function is gonna run before the codes inside modifier block or after. Wherever it should be runned.
