...
contract TokenA is IToken {
    ...
    mapping(address => uint256) balances;       // Bu Token'dan kimde ne kadar var

    // Allower -> Allowee -> Amount     Dışardan contract'lar ile bu parayı çekmek içn gerekli.
    mapping(address => mapping(address => uint256)) allowances;     // Kimler bu Token'a sahip olabilir.
