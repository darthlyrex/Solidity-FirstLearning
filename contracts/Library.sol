...
contract Library {
    ...
    // for every uint the function for Math library are can be used.
    // for every uint array the function for Search library are can be used.
    using Math for uint;
...
contract HumanContract {
    // ID for every person: map of the people
